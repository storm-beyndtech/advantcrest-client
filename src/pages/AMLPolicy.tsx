      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-8 bg-slate-900 rounded-lg p-6">
          <p className="text-gray-300 leading-relaxed">
            AdvantCrest is committed to the highest standards of the Anti-Money
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-gray-300 leading-relaxed">
            <p>
              AdvantCrest adheres to the principles of Anti-Money Laundering and
            ...
            <div className="bg-red-900/20 border border-red-700 rounded-lg p-4">
              <p className="text-red-300 font-medium">
                To prevent money laundering, AdvantCrest neither accepts nor pays
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            AdvantCrest will make sure that it is dealing with a real person or
            legal entity. AdvantCrest also performs all the required measures in
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            ...
            Before AdvantCrest starts any cooperation with the client, the
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-gray-300 leading-relaxed">
            <p>
              In addition to gathering information from clients, AdvantCrest
            ...
            <p>
              AdvantCrest has implemented a system of monitoring transactions
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            ...
            AdvantCrest must meet the following strict requirements:
          </p>
            ...
            <div className="bg-slate-900 rounded-lg p-6">
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    Due to AML/CTF laws, AdvantCrest cannot receive or deposit
                ...
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">•</span>
                  <span>
                    Funds sent to AdvantCrest must be provided on AdvantCrest
                    platform only
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    card, or Alternative Payment Method (Crypto) on AdvantCrest
                    platform
                  </span>
                </li>
                <li className="flex items-start">
        ...
        <section className="mb-8">
          ...
          <div className="bg-red-900/20 border border-red-700 rounded-lg p-6">
            <p className="text-red-200 leading-relaxed mb-4">
              In cases of an attempt to execute transactions which AdvantCrest
            ...
            <p className="text-red-200 leading-relaxed">
              AdvantCrest reserves the right to suspend any client's operation
              which can be regarded as illegal or may be related to money
              laundering. AdvantCrest has complete discretion to temporarily
