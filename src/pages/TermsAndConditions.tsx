      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-700">
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">
            AdvantCrest Ltd. Client Agreement - Please read these terms carefully
        ...
        <div className="space-y-6">
          ...
          >
            <SubSection title="1.1. INTRODUCTION">
              <div className="space-y-3 text-sm">
                <p>
                  ...
                  AdvantCrest Ltd. ("we", "us" or "AdvantCrest"), an international
                ...
                <p>
                  ...
                  of cancellation. Where AdvantCrest has suffered loss, it
                  ...
                  losses sustained by AdvantCrest in closing out the Order.
                </p>
              </div>
            </SubSection>
            ...
            <SubSection title="3.4. TRADING CONFIRMATIONS AND STATEMENTS">
              <div className="text-sm space-y-3">
                <p>
                  a) Each time the Client places an Order with AdvantCrest, a
                  confirmation of the executed trade will appear in the
                  AdvantCrest Trading Platform.
                </p>
                <p>
                ...
                <p>
                  c) AdvantCrest will make available Daily and Monthly Statements
                  via AdvantCrest Trading Platform or online service.
                </p>
                <p>
                  d) Following the end of day settlement time, provided the
                  Client has transacted or has an open Position, AdvantCrest
                  Trading Platform will produce a Daily Statement which will be
                  emailed to the Client at their registered email address and
                  then made available on the AdvantCrest Trading Platform.
                </p>
                <p>
                  e) Following month-end, AdvantCrest will produce an electronic
                  version of the Client's trading statement which will be
                  emailed to the Client and be available on the AdvantCrest
                  Trading Platform.
                </p>
                <p>
                  f) The Client is responsible for promptly checking all
                  contents of Confirmations and the Daily and Monthly
                  Statements. The client must immediately notify AdvantCrest if
                  they become aware that there is an error in the Confirmation
                  or the Statements. AdvantCrest is entitled to assume that the
                  Confirmations and Statements are correct unless the Client
                  notifies AdvantCrest of any error within 48 hours following us
            ...
            <SubSection title="3.5. TELEPHONE AND EMAIL TRANSACTIONS">
              <div className="text-sm space-y-3">
                <p>
                  a) An Authorized User may request AdvantCrest to accept
                  Instructions and enter Orders by telephone. AdvantCrest has
                  sole discretion to accept Instructions and enter Orders by
                  telephone.
                </p>
                <p>
                  b) AdvantCrest may check the authority of the caller by
                  requesting the caller give his or her name and confirming that
                  such name has been notified to AdvantCrest by the Client as an
                  Authorized User.
                </p>
                <p>
                  c) The Client acknowledges and agrees that AdvantCrest may make
                  a recording of each telephone Instruction and any other
                  conversation received from a Client or an Authorized User. The
                  recording remains the property of AdvantCrest and can be used
                  to confirm terms and conditions of any transaction where there
                  is a dispute, and for training and monitoring purposes.
                </p>
                <p>
                  d) An Authorized User may request AdvantCrest to accept
                  Instructions and enter Orders by email. The Client
                  acknowledges and agrees that upon the acceptance by AdvantCrest
            ...
            <SubSection title="3.6. ONLINE SERVICES">
              <div className="text-sm space-y-3">
                ...
                <ul className="list-disc ml-6 space-y-1">
                  <li>place your Orders or issue Instructions to AdvantCrest</li>
                  <li>
                  ...
                  <li>
                    use such other facilities as AdvantCrest may from time to
                    time make available through the Online services
                  </li>
                </ul>
                <p>
                  b) The Client must provide AdvantCrest on request with a list
                  of Authorized User(s) and is responsible for informing
                  AdvantCrest with any changes to that list.
                </p>
                <p>
                  c) An Online Service may be a proprietary service provided by
                  AdvantCrest or a service provided to you by a third party
                  pursuant to an arrangement with AdvantCrest.
                </p>
                <p>
                  d) The Client is responsible for complying with the operations
                  aspects of Online Services provided by AdvantCrest or the
                  provider of the Online Services.
                </p>
                <p>
                  e) AdvantCrest may at any time without notice suspend, withdraw
                ...
                <p>
                  f) Clients can contact AdvantCrest in writing to terminate
                  their access to an Online Service.
                </p>
                <p>
                  g) AdvantCrest can delay, decline or reverse any Order if
                  AdvantCrest reasonably suspects that the transaction might be
                ...
                <ul className="list-disc ml-6 space-y-1">
                  ...
                  <li>
                    AdvantCrest is entitled to rely on all Instructions given
                    using the Security Details
                  </li>
                  <li>
                    AdvantCrest is not liable for any loss caused by it acting on
                  ...
                  <li>
                    AdvantCrest may change minimum specifications and make
                ...
                <p>
                  ...
                  and equipment. AdvantCrest will not be responsible for any loss
                ...
                <p>
                  ...
                  devices are free from viruses and other malware. AdvantCrest
                  cannot guarantee that Online Services will be free from
                  infection.
                </p>
                <p>
                  o) By breaching this provision, a Client may also commit a
                  criminal offence. AdvantCrest may report any such breach to law
            ...
            <SubSection title="3.7. HEDGED POSITIONS">
              <div className="text-sm space-y-3">
                <p>
                  a) AdvantCrest may allow you to execute Hedged Positions on
                ...
                <p>
                  b) AdvantCrest reserves the right to reduce the Deposit to zero
                ...
                <p>
                  d) AdvantCrest may close all or part of any Hedged Position at
            ...
            <SubSection title="3.8. DELAYS AND QUOTING ERRORS">
              <div className="text-sm space-y-3">
                <p>
                  a) While AdvantCrest will make every reasonable effort to
                  process the Client's Order promptly, in the absence of gross
                  negligence or wilful misconduct, AdvantCrest cannot be held
                  liable for delays, damages, failures, or errors in the
                  completion of the Order, including instances of off quotes
                  situations.
                </p>
                <p>
                  b) In the event of a quoting or off quote error, AdvantCrest:
                ...
                <p>
                  ...
                  AdvantCrest acting reasonably, of the relevant currency at the
                  time such quoting error occurred.
                </p>
                <p>
                  d) If AdvantCrest is unable to perform its obligations under
                  this Agreement or an Order because of factors beyond its
                  control or because of a Force Majeure Event, AdvantCrest will
                ...
                <p>
                  e) AdvantCrest may give a Notice to the Client at any time if
                  it forms the view that market conditions in the relevant
                  financial market for the currency concerned are seriously
                  disturbed. When such Notice is given, AdvantCrest's obligations
            ...
            <SubSection title="3.9. TRADING HOURS">
              <div className="text-sm space-y-3">
                ...
                <p>
                  ...
                  AdvantCrest offers. We give notice of such public holidays and
          ...
          >
            <SubSection title="4.1. INITIAL MARGIN">
              <p className="text-sm">
                ...
                Position as calculated by AdvantCrest.
              </p>
            </SubSection>
            ...
            <SubSection title="4.2. MARGIN OBLIGATIONS">
              <div className="text-sm space-y-3">
                <p>
                  a) The Client must pay to AdvantCrest such amounts of Margin as
                  it may require under this Agreement.
                </p>
                <p>
                  b) A Margin Deposit is credited by AdvantCrest at the time
                  cleared funds have been received into the Client Account or
                  such earlier time as allowed by AdvantCrest, so a Margin
                  requirement for any anticipated or Open Positions by
                  AdvantCrest is not satisfied unless and until the Client's
                  payment is received in cleared funds into the Client Account.
                </p>
                <p>
                  c) AdvantCrest will not be liable for any losses including
                ...
                <p>
                  ...
                  required by AdvantCrest whether or not AdvantCrest gives any
                ...
                <p>
                  ...
                  through the AdvantCrest Trading Platform any notifications that
                  AdvantCrest may provide, the Margin deposited or any Minimum
                ...
                <p>
                  ...
                  Closed Out by AdvantCrest without prior notice to the Client.
                </p>
                <p>
                  g) AdvantCrest may, in its absolute discretion, provide the
                  Client with further time to meet their Margin Requirements.
                  Such permission will only be effective once confirmed in
                  writing by AdvantCrest and only to the extent provided in the
                  notice.
                </p>
                <p>
                  h) If AdvantCrest asks the Client to transfer money to it to
                  meet its Margin requirement, the client must take this action
                  immediately. If they don't, AdvantCrest will consider it a
                  Default Event under these terms. AdvantCrest may also cancel
            ...
            <SubSection title="4.3. MARGIN CLOSE-OUT">
              <p className="text-sm">
                AdvantCrest Margin practice is an automated process where the
                AdvantCrest Electronic Trading Platform displays a visual warning
                ...
                visual warning automatically on the AdvantCrest Trading Platform.
            ...
            <SubSection title="4.4. CHANGING MARGIN PERCENTAGE">
              <div className="text-sm space-y-3">
                <p>
                  a) AdvantCrest may vary the Margin Percentage in respect of any
                ...
                <p>
                  ...
                  immediately on AdvantCrest demand.
                </p>
              </div>
            </SubSection>
            ...
            <SubSection title="4.5. MARK TO MARKET PAYMENTS">
              <div className="text-sm space-y-3">
                <p>
                  a) AdvantCrest calculates the Order Value as at each Valuation
                  Time.
                </p>
                <p>
                ...
                <p>
                  d) All Mark to Market Payments: i. AdvantCrest owes to the
            ...
            <SubSection title="4.6. FORCED LIQUIDATION">
              <div className="text-sm space-y-3">
                <p>
                  ...
                  Margin. AdvantCrest reserves its rights to close out all Open
                  Positions: i. if at any time the Deposit held by AdvantCrest is
                  approaching or is no longer sufficient to cover the negative
                  mark to market value of any or all Open Positions that the
                  Client has open with AdvantCrest; or ii. at any time, and from
                  time to time, AdvantCrest determines that the value of all of
                  the Client's Open Positions represents a substantial net
                  unrealized loss to the Client such that, in AdvantCrest'
                ...
                <p>
                  b) AdvantCrest shall have the right, at our sole discretion, to
                  determine the Mark to Market value from time to time.
                </p>
                <p>
                  c) In addition to other remedies available to AdvantCrest, if
                  the Client fails to pay any amount when due under this
                  Agreement, or if a Default Event occurs, AdvantCrest has the
          ...
          >
            <SubSection title="5.1. INTEREST CHARGES ON OPEN MARGIN FX POSITIONS">
              <div className="text-sm space-y-3">
                <p>
                  ...
                  determined by AdvantCrest in accordance with this clause:
                </p>
                <ul className="list-disc ml-6 space-y-1">
                  <li>
                    if the Client is the Long Party and the Bought Swap Rate is
                    higher than the Sell Swap Rate, AdvantCrest must pay you
                    interest on the Open Position of any Orders at the rate that
                    is the Bought Swap Rate minus the Sell Swap Rate;
                  </li>
                  <li>
                    if the Client is the Long Party and the Bought Swap Rate is
                    less than the Sell Swap Rate, the Client must pay AdvantCrest
                    interest on the Open Position of any Orders at the rate that
                    is the Bought Swap Rate minus the Sell Swap Rate;
                  </li>
                  <li>
                    if the Client is the Short Party and the Sell Swap Rate is
                    higher than the Bought Swap Rate, AdvantCrest must pay the
                  ...
                  <li>
                    ...
                    AdvantCrest interest on the Open Position of any Orders at
                ...
                <p>
                  ...
                  the Client agrees to pay AdvantCrest a transaction fee of up to
                  10% of the value of the Swap Charge or Swap Credit.
                </p>
                <p>
                  d) Swap Charges or Swap Credits and AdvantCrest' transaction
            ...
            <SubSection title="5.2. INTEREST CHARGES ON OPEN SPOT CFD POSITIONS">
              <div className="text-sm space-y-3">
                <p>
                  ...
                  AdvantCrest multiplying the value of the contract at the end of
                  the Trading Day by the Reference Interest Rate and adjusted
                  for any dividend in relation to the underlying asset or
                  instrument.
                </p>
                <p>
                  b) AdvantCrest may, on its website, designate a spot CFD as a
                  ...
                  eight onwards. If AdvantCrest reasonably believes that a Client
                  has engaged in Suspicious Trading Activity with respect to a
                  swap-free Spot CFD, AdvantCrest reserves the right to apply
            ...
            <SubSection title="5.3. ROLLOVER CHARGES & CREDITS FOR OPEN FUTURES CFD POSITIONS">
              <div className="text-sm space-y-3">
                ...
                <p>
                  ...
                  contract price. AdvantCrest will not automatically roll over an
                  Open Position for a Futures CFD held at the Close of Trade on
                  the Close-Out Date unless AdvantCrest has provided reasonable
            ...
            <SubSection title="5.4. COMMISSIONS FEES AND EXPENSES">
              <div className="text-sm space-y-3">
                <p>
                  ...
                  other fee charged or levied on AdvantCrest, or other expense
                  incurred by AdvantCrest, arising from any action taken pursuant
                  to this Agreement; and ii. all relevant taxes and expenses
                  incurred by the Client in connection with this Agreement.
                </p>
                <p>
                  b) The Client confirms and acknowledges that AdvantCrest is,
                  without limiting its powers to recover amounts owing by the
                  Client to AdvantCrest in any other way, permitted to deduct,
                  without further reference to the Client, charges relating to
                  any services provided by AdvantCrest including administration
                  ...
                  AdvantCrest by others with respect to the Client's transactions
                  including, but not limited to tracing fees.
                </p>
                <p>
                  c) AdvantCrest may in its absolute discretion waive or reduce
                ...
                <p>
                  ...
                  with AdvantCrest, the Client must pay all transaction charges,
                  fees, settlements, interest and any other amounts due under
                  this Agreement on demand by AdvantCrest in cleared funds or
                  otherwise as required in accordance with the terms of this
                  Agreement.
                </p>
                <p>
                  e) The Client agrees that AdvantCrest may at any time share
            ...
            <SubSection title="5.5. SWAP FREE OR ISLAMIC ACCOUNT">
              <div className="text-sm space-y-3">
                ...
                <p>
                  d) AdvantCrest reserves the right to revoke or cancel a Swap
                  Free Account without having to provide any reason. If
                  AdvantCrest detects that a Swap Free Account is being abused by
                  ...
                  with the usage of a Swap Free Account, then AdvantCrest
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                ...
                circumstance, where AdvantCrest determines, in its absolute
                discretion, that such guarantee is required.
              </p>
              <p>
                b) The Guarantor acknowledges that AdvantCrest is acting in
              ...
              <p>
                ...
                AdvantCrest compliance with their obligations in connection with
              ...
              <p>
                ...
                to comply with those obligations on demand from AdvantCrest. A
                demand may be made whether AdvantCrest has made demand on the
                Client.
              </p>
              <p>
                e) The Guarantor indemnifies AdvantCrest against any liability or
              ...
              <p>
                ...
                demand from AdvantCrest.
              </p>
              <p>
                g) AdvantCrest needs not incur expense or make payment before
              ...
              <p>
                ...
                requiring AdvantCrest to commence proceedings or enforce any
              ...
              <p>
                ...
                withholding or deduction, the Guarantor agrees to pay AdvantCrest
                such additional amount to ensure that the amount received by
                AdvantCrest equals the full amount AdvantCrest would have received
                had no withholding or deduction been made.
              </p>
              <p>
                l) The rights given to AdvantCrest under this guarantee and
                ...
                x. acquiescence or delay by AdvantCrest or any other person.
              </p>
              <p>
                ...
                counterclaim against AdvantCrest; or ii. exercise any legal right
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                a) If a Corporate Action occurs, AdvantCrest will reasonably
              ...
              <p>
                b) AdvantCrest will make dividend payments if: i. a Client is the
                Long Party for a Share CFD which goes ex-dividend, AdvantCrest
                ...
                ex-dividend, AdvantCrest will debit the declared cash dividend
              ...
              <p>
                ...
                subject to a Merger Event, AdvantCrest reserves the right to
                close any or all affected Open Positions at any time during the
                Merger Event. AdvantCrest will not close any Open Position that
              ...
              <p>
                d) AdvantCrest reserves the right to adjust the opening price of
              ...
              <p>
                ...
                reasonable result, AdvantCrest may close your Open Position at
              ...
              <p>
                ...
                ex-dividend, AdvantCrest is required by US tax legislation to
                withhold 30% of the cash adjustment to reflect the impact of the
                declared dividend. AdvantCrest will remit the amount withheld to
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                ...
                index so that AdvantCrest is unable to determine the price of the
                Underlying Asset, then AdvantCrest will take the price of the
              ...
              <p>
                ...
                AdvantCrest at its discretion may Close-Out your part or all of
                your Positions. When this happens, AdvantCrest will decide the
              ...
              <p>
                c) AdvantCrest reserves the right at all times during any
          ...
          >
            ...
            <SubSection title="9.2. ASSIGNMENT">
              <p className="text-sm">
                ...
                AdvantCrest. AdvantCrest may, however, transfer any rights or
                ...
                of AdvantCrest' business to another person or entity.
              </p>
            </SubSection>
            ...
            <SubSection title="9.3. TERMINATION">
              <div className="text-sm space-y-3">
                <p>
                  ...
                  or AdvantCrest by Notice to the other in writing. However,
                ...
                <p>
                  b) If AdvantCrest is made aware of or has reason to believe any
                  ...
                  exist; v. that AdvantCrest is unable to make prices in the
                  ...
                  then AdvantCrest at its sole discretion, may terminate this
                  Agreement immediately by Notice to the Client, and AdvantCrest
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                a) In addition to other rights available to AdvantCrest, the
                Client authorizes AdvantCrest to: i. appropriate, transfer,
                credit, apply or pay monies that may be received or held by
                AdvantCrest the Client's behalf in payment of any amounts which
                may be outstanding by the Client to AdvantCrest or to an agent of
                AdvantCrest in a transaction effected on the Client's behalf; and
                ii. set-off against any amounts due to it by the Client, any
                amounts received by AdvantCrest from or on behalf of the Client
                including but not limited to monies received as Deposits or
                Margin Calls. AdvantCrest may determine the application of any
                amounts which are to be set-off at its own discretion.
              </p>
              <p>
                b) Payments by the Client to AdvantCrest in accordance with this
              ...
              <p>
                ...
                in respect of tax from any payment to be made or if AdvantCrest
                ...
                agrees to keep AdvantCrest indemnified against that tax and
                agrees to pay to AdvantCrest any additional amounts required to
                ensure AdvantCrest receives the full net amount that is equal to
                the amount AdvantCrest would have received had a deduction,
              ...
              <p>
                ...
                AdvantCrest and the Client are satisfied in full. Until this
                time, Deposits or Margin Calls will not constitute a debt due
                from AdvantCrest to the Client nor will the Client have any right
                to receive payment of these funds.
              </p>
              <p>
                e) If the Agreement is terminated, the Client and AdvantCrest
                agree that the claims against each other are finally discharged
                by means of close-out netting. AdvantCrest will determine the
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                The trading systems of AdvantCrest are designed with safeguards
                ...
                Should the margin level equal to, or drop below 50%, AdvantCrest
              ...
              <p>
                ...
                the client should inform the AdvantCrest support team. AdvantCrest
              ...
              <p>
                Negative balance accounts – AdvantCrest is entitled to combine
                the balances of any other accounts you hold with us, including
                any Joint Accounts to affect any set-off of amounts owing
                between you and AdvantCrest, pursuant to our terms and conditions
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                a) The Client shall indemnify and hold AdvantCrest harmless from
              ...
              <p>
                b) The Client also agrees to promptly pay AdvantCrest for all
                damages, costs and expenses, including reasonable legal fees and
                expenses, incurred by AdvantCrest in the enforcement of any of
                the provisions of this Agreement.
              </p>
              <p>
                c) AdvantCrest is not responsible for any delays, charges or loss
                ...
                agrees to indemnify AdvantCrest and be liable for any losses or
                charges incurred by AdvantCrest arising from such error on the
                Client's behalf.
              </p>
              <p>
                d) AdvantCrest will not be liable under any circumstances for any
              ...
              <p>
                ...
                liability AdvantCrest may owe the Client under any statutory
                rights the Client may have that cannot be excluded or limited by
                law.
              </p>
              <p>
                f) If a Default Event occurs, then AdvantCrest may, at its sole
                ...
                value; and/or iv. take any other action that AdvantCrest
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                a) The Client acknowledges and agrees that AdvantCrest is
                ...
                AdvantCrest may keep records of the contents and results of such
                searches in accordance with all applicable Laws.
              </p>
              <p>
                b) AdvantCrest reserves the right to collect such information as
                ...
                Laundering and Counter-Terrorism Financing Laws. AdvantCrest may
                ...
                obligation to inform the Client it has done so. AdvantCrest may
                ...
                or appropriate by AdvantCrest.
              </p>
              <p>
                c) Personal information collected by AdvantCrest is treated as
                confidential and is protected by the Data Protection Law.
                AdvantCrest will only collect personal information which is
                necessary to perform the services contemplated by this
                Agreement.
              </p>
              <p>
                d) AdvantCrest will treat the Client's personal information in
                accordance with its privacy policy, which the Client may obtain
                on the Website.
              </p>
              <p>
                e) AdvantCrest will use reasonable precautions to maintain the
                confidentiality of information AdvantCrest receives from the
                Client and material and/or data the Client provides, creates,
                inputs or develops in connection with the Client's use of the
                AdvantCrest services. Nonetheless, because such information,
                material and/or data may be provided through the internet, the
                Client hereby acknowledges and agrees that AdvantCrest cannot
              ...
              <p>
                ...
                releases and indemnifies AdvantCrest from any claim arising out
                of a Third-Party intercepting, accessing, monitoring or
                receiving any communication from a Client intended to be
                provided to AdvantCrest or from AdvantCrest intended to be
                provided to the Client.
              </p>
              <p>
                g) The Client acknowledges and agrees that AdvantCrest may
                ...
                administering or maintaining the AdvantCrest services, or to
                comply with applicable Laws.
              </p>
              <p>
                h) Due to the inherent risks in transferring currency between
                parties located in different countries, AdvantCrest takes
                ...
                by AdvantCrest, to ensure compliance with all applicable
              ...
              <p>
                ...
                AdvantCrest, may be disclosed to and reviewed by law enforcement
                ...
                transaction entered into with AdvantCrest.
              </p>
            </div>
          </CollapsibleSection>
          ...
          >
            <div className="text-sm space-y-3">
              ...
              <ul className="list-disc ml-6 space-y-1">
                <li>
                  AdvantCrest may use and disclose personal information for the
          ...
          >
            <div className="text-sm space-y-3">
              <p>
                a) AdvantCrest may, to the extent of your authorization, send a
          ...
          >
            <div className="text-sm space-y-3">
              ...
              <p>
                ...
                result that AdvantCrest' rights, powers or remedies are adversely
          ...
          >
            <div className="text-sm space-y-3">
              ...
              <p>
                b) The Client agrees to do anything AdvantCrest reasonably
        ...
        <div className="mt-16 pt-8 border-t border-slate-700">
          <div className="bg-slate-900/50 rounded-lg p-6">
            ...
            <p className="text-sm text-slate-300 leading-relaxed mb-4">
              By using AdvantCrest services, you acknowledge that you have read,
            ...
            <div className="text-xs text-slate-500">
              <p>
                ...
                using AdvantCrest services. Please ensure you understand all
