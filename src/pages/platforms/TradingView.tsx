      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-300 mb-8">
            Advanced charting platform with social trading and comprehensive analysis tools
          </p>
  ...
  const features = [
    {
      ...
      description: "Professional charting tools with 100+ technical indicators, drawing tools, and customizable layouts"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Social Trading",
      description: "Follow top traders, share ideas, and learn from a community of 30+ million active traders"
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Global Markets",
      description: "Access real-time data from 100+ exchanges covering stocks, forex, crypto, and commodities"
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Real-Time Data",
      description: "Lightning-fast market data with professional-grade charts and instant price updates"
    },
    {
      icon: <Share2 className="w-8 h-8" />,
      title: "Idea Sharing",
      description: "Publish trading ideas, analysis, and strategies to build your reputation in the community"
    },
    {
      icon: <MessageSquare className="w-8 h-8" />,
      title: "Chat & Alerts",
      description: "Built-in chat, customizable alerts, and notifications to stay connected with markets"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Everything you need for professional trading and market analysis in one platform
          </p>
        </motion.div>
    ...
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Comprehensive suite of tools for technical analysis and social trading
          </p>
        </motion.div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 ${
                plan.popular ? 'ring-2 ring-purple-500' : 'border border-slate-200'
              }`}
            >
              {plan.popular && (
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Start Charting with <span className="text-purple-600">TradingView</span>
          </h2>
          <p className="text-xl text-slate-600 mb-8">
            Join millions of traders who trust TradingView for advanced charting and social trading
          </p>
