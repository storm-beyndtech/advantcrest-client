...
const Header = (props: {
  ...
  const handleCopy = async (textToCopy: string) => {
    try {
      await navigator.clipboard.writeText(
        `https://advantcrest.com/register/${textToCopy}`,
      );
  ...
  return (
    <header className="bg-white dark:bg-emerald-950/40 border-b border-gray-200 dark:border-emerald-800/30 z-10">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-6 2xl:px-8">
        <div className="flex items-center gap-2 justify-between h-14">
          <button
