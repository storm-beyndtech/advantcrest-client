...
export default function AdminSidebar({
  ...
  return (
    <aside
      ref={sidebar}
      className={`text-xs absolute left-0 top-0 z-999999 flex h-screen w-72 flex-col overflow-y-hidden bg-bodydark1 lg:dark:bg-bodydark1/40 duration-300 ease-linear lg:static lg:translate-x-0 ${
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <nav className="mt-5 py-4 px-4 lg:mt-9">
          ...
          <ul className="flex flex-col gap-1.5">
            ...
            <li
              className="cursor-pointer text-sm group relative flex items-center gap-2.5 rounded-sm py-2.5 px-4 text-gray-300 font-montserrat duration-300 ease-in-out hover:bg-black dark:hover:bg-black"
              onClick={() => logout()}
            >
