          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="text-center px-4">
              ...
              <p className="text-sm md:text-base text-gray-300">
                AdvantCrest operates in accordance with the financial regulations
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center px-2 py-6">
              <p className="text-gray-300 mb-8">
                All AdvantCrest clients are able to profit from the bullish and
              ...
              <p className="text-base font-semibold text-brandblue">
                Profit from both up and down market cycles with AdvantCrest!
              </p>
            </div>
