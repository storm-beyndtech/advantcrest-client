      ...
      <div className="p-4 border-b border-gray-200 dark:border-emerald-800/30">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center text-xs text-gray-500 dark:text-gray-400">
            ...
            <button
              onClick={fetchTrades}
              disabled={loading}
              className="ml-2 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-emerald-900/30 focus:outline-none"
            >
              <RefreshCw
        ...
        <div className="mt-2 relative">
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-gray-50 dark:bg-emerald-950/20 border border-gray-200 dark:border-emerald-800/30 rounded-md text-xs text-gray-700 dark:text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-emerald-400"
            value={searchQuery}
