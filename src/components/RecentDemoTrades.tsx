...
const RecentDemoTrades = ({ changes }: any) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-900/20 rounded-lg shadow-sm overflow-hidden">
        ...
        {loading ? (
          ...
          <ul className="divide-y divide-gray-100 dark:divide-gray-700">
            {filteredTrades.map((trade) => (
              <li
                key={trade._id}
                className="px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-900 transition duration-150 ease-in-out"
              >
                <div className="flex items-center justify-between">
